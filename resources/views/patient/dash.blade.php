...
<body>
        ...
        <main class="main-content">
            ...
            <div class="actions">
                <a href="{{route('patient.inquiry01')}}"><button> <div class="circle"><svg width="65" height="65" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="22.5" cy="22.5" r="22.5" fill="#395886"/><path d="M21.3269 32H11.75C11.1977 32 10.75 31.5523 10.75 31V16C10.75 13.7909 12.5409 12 14.75 12H29.25C31.4591 12 33.25 13.7909 33.25 16V21.2308" stroke="#F0F3FA" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M15.75 24.5H19.5" stroke="#F0F3FA" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M15.75 19.5H23.25" stroke="#F0F3FA" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><circle cx="27.625" cy="26.375" r="3.375" stroke="#F0F3FA" stroke-width="2"/><path d="M30.125 28.875L33.875 32.625" stroke="#F0F3FA" stroke-width="2" stroke-linecap="round"/></svg></div><p class="p">Make an <br> Inquiry</p></button></a>
